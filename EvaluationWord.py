...
def main():
    ...
    parser.add_argument("--segment_model", type=str,default="./_data/segment/01/hwkrseg_infer_20.h5",
                       help="filename of segment model")
    parser.add_argument("--recog_model", type=str,default="./_data/segment/02/NTCharRecog_20.h5",
                       help="filename of char recog model")
    parser.add_argument("--input", type=str, default="./_data/train_data2/za    `.csv",
                        help="filename of evaluation data list")
    parser.add_argument("--output", type=str, default="./_data/evalresult/eval_result.csv",
